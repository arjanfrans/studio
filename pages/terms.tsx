    ...
    return (
        <Container maxWidth="lg">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to Music Studio Hard, accessible from <a
                        href="https://6971.productions" rel="external nofollow noopener"
                        target="_blank">https://6971.productions</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: musicstudiohard@gmail.com</li>
            </ul>
        </Container>
    );
}
